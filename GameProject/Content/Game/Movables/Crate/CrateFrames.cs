...
namespace GameProject.Content.Game.Movables.Crate {
    internal static class CrateFrames {
        ...
        static CrateFrames() {
            ...
            idleFrames.Add(new Frame(
                boundingBox: SpritesheetTool.SpritePositionToRectangle(101, 101, 5, 0),
    ...
    boundingBox: SpritesheetTool.SpritePositionToRectangle(101, 101, 5, 0),
        hitbox: ContentLoadingTools.CoordToRect(0, 0, 101, 101)
            ...
            breakingFrames.Add(new Frame(
                boundingBox: SpritesheetTool.SpritePositionToRectangle(101, 101, 5, 1),
                    hitbox: ContentLoadingTools.CoordToRect(0, 10, 101, 101)
                ));
            breakingFrames.Add(new Frame(
    boundingBox: SpritesheetTool.SpritePositionToRectangle(101, 101, 5, 2),
        hitbox: ContentLoadingTools.CoordToRect(0, 24, 101, 101)
    ));
            breakingFrames.Add(new Frame(
    boundingBox: SpritesheetTool.SpritePositionToRectangle(101, 101, 5, 3),
        hitbox: ContentLoadingTools.CoordToRect(0, 41, 101, 101)
    ));
            breakingFrames.Add(new Frame(
    boundingBox: SpritesheetTool.SpritePositionToRectangle(101, 101, 4, 4),
