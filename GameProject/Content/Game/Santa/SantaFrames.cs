...
namespace GameProject.Content.Game.Santa {
    internal static class SantaFrames {
        internal static List<SantaFrame> idleFrames = new List<SantaFrame>();
        internal static List<SantaFrame> walkingFrames = new List<SantaFrame>();

        static SantaFrames() {
            #region idleFrames
            idleFrames.Add(new SantaFrame(
            ...
            #endregion
            #region walingFrames
            walkingFrames.Add(new SantaFrame(
